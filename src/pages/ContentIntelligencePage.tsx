...
import {
  ...
  AlertTriangle, XCircle, GraduationCap, Calendar, Search, X, Play,
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-background p-6 space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Análise de conteúdo · campanhas <span className="text-amber-500 font-mono">Dist</span></p>
        </div>
