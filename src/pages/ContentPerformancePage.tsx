...
export default function ContentPerformancePage() {
  const { rows, loading, error, since, setSince, until, setUntil, reload } = useContentPerformance();
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-0.5">Campanhas Descoberta · filtro fixo: <span className="text-amber-500 font-mono">Dist</span></p>
        </div>
